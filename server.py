...
# Maintaining user data in user_data.txt
user_data = {}
...
class WebSocket(object):
    ...
    def decodeCharArray(self, stringStreamIn):
        ...
        if datalength == 126:
            ...
            indexFirstMask = 10
        masks = [m for m in byteArray[
                            indexFirstMask: indexFirstMask + 4]]  # The MASK bit simply tells whether the message is encoded.
